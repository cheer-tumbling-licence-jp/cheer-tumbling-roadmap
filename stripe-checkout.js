...
(function () {
  ...
  window.STRIPE_PRICE_IDS = window.STRIPE_PRICE_IDS || {
    ...
    // 2026-08-31 価格改定：完全1on1 ¥7,500 → ¥19,800
    //    新Price ID は 2026-09-03 に発行済み（lookup_key: training_1on1_monthly_v2）。
    //    旧価格 price_1U8hkqCD8zFCJuDizIhJh8sx（¥7,500）は既存契約者が継続中のため
    //    Stripe 上でアーカイブしないこと。
    training_1on1:  'price_1UBPlNCD8zFCJuDiJKwlVsDO'   // ¥19,800 完全1on1
  };
